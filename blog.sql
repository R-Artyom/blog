...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 12 2022 г., 09:46
...
(57, 10, 1, 'Первый', 1, '2022-12-11 16:47:26');
...
(1, 8, 'Иванов Иван Иванович', 'admin@gmail.com', '$2y$10$ABMDc.6IcRZyfdPnJqCCGuYlVIXarYxHM.eFXHE8p423KUtDcC3ly', '1.jpg', 'Я - робот', '2022-09-09 10:18:40', '2022-12-12 09:18:27'),
...
--
ALTER TABLE `comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Уникальный идентификатор комментария', AUTO_INCREMENT=59;

--
-- AUTO_INCREMENT для таблицы `posts`
--
ALTER TABLE `posts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Уникальный идентификатор статьи', AUTO_INCREMENT=16;
...
--
ALTER TABLE `subscribers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Уникальный идентификатор подписчика', AUTO_INCREMENT=23;
