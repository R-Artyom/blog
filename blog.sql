...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 26 2022 г., 07:58
...
(46, 2, 2, 'Манагер', 1, '2022-11-29 19:37:40', '2022-12-20 15:30:34'),
...
(1, 'home_elements_per_page', '5', 'Количество статей на главной странице', '2022-12-25 15:28:05', '2022-12-26 07:46:53');
...
(10, 'asd@mail.ru', 'd140eaa0b190a2c6d957b2b5b6c8f174');
...
(4, 2, 'Васильев Василий Васильевич', 'vasiliev@gmail.com', '$2y$10$bZbHhWIfGNUA9UHNe0HNc.6XK9J3e2Y56v0FOU1IkQo.oy9yc29Zy', '4_1671096409.jpg', 'Краткость', '2022-09-09 10:18:47', '2022-12-20 15:29:58'),
(5, 2, 'Андреев Андрей Андреевич', 'andreev@gmail.com', '$2y$10$7vWGrFJf35Hj/o/5FL.90uLvhctur1cuXyWsbRJCTLFB.qBnGho7W', '', '', '2022-09-09 10:18:49', '2022-12-19 19:22:45'),
...
--
ALTER TABLE `comments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Уникальный идентификатор комментария', AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT для таблицы `pages`
--
ALTER TABLE `pages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Уникальный идентификатор статичной страницы', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `posts`
--
ALTER TABLE `posts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Уникальный идентификатор статьи', AUTO_INCREMENT=73;
...
--
ALTER TABLE `subscribers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Уникальный идентификатор подписчика', AUTO_INCREMENT=11;
