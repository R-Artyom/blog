<div class="row d-flex profile-thumbnail m-auto border shadow">
    ...
    <?php else:?>
        <form method="post" class="py-3 px-4 m-auto" enctype="multipart/form-data" action="<?=isset($page) ? PATH_ADMIN_PAGES . '/' . $page->id . '/edit' : PATH_ADMIN_PAGES . '/add'?>">
            ...
            <input type="text" name="imgName" value="<?=isset($page) ? $page->img_name : null?>" hidden>
            <p class="mb-2">
                <strong>Фото:</strong>
            </p>
            <div>
            ...
            <div>
                <label class="placeholder-box">
                    <input type="text" class="form-control form-style-3 rounded-0 <?=$form['error'] === FORM_TITLE ? 'focus' : ''?>" maxlength="30" name="title" value="<?= $form['title'] ?? ''?>" required>
                    <span class="placeholder-text">Введите заголовок страницы (не более 30 символов) <strong class="text-danger">*</strong></span>
                </label>
            ...
            <div>
                <label class="placeholder-box">
                    ...
                    <span class="placeholder-text">Введите текст страницы <strong class="text-danger">*</strong></span>
                </label>
            ...
            <div class="row mb-3">
                <div class="col d-flex justify-content-start align-items-end">
                    <a class="link-style-4" href="<?=PATH_ADMIN_PAGES?>">
                        <i class="bi bi-box-arrow-left me-1"></i>
                        <span class="text-decoration-underline">Отмена</span>
                    </a>
                </div>
                <div class="col d-flex justify-content-end">
                    <button type="submit" class="btn btn-style-4 width-200 rounded-0" name="save" value="yes" formnovalidate><?=isset($page->id) ? 'Сохранить изменения' : 'Добавить страницу на сайт'?></button>
                </div>
            </div>
        </form>
    <?php endif?>
