        ...
        <form method="post" class="py-3 px-4 m-auto" enctype="multipart/form-data" action="<?=isset($page) ? PATH_ADMIN_PAGES . '/' . $page->id . '/edit' : PATH_ADMIN_PAGES . '/add'?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col d-flex justify-content-end">
                    <button type="submit" class="btn btn-style-4 rounded-0" name="save" value="yes" formnovalidate><?=isset($page->id) ? 'Сохранить изменения' : 'Добавить страницу на сайт'?></button>
                </div>
            </div>
        </form>
    </div>
